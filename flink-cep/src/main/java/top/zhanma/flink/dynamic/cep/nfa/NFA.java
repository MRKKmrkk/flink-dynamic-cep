...
package top.zhanma.flink.dynamic.cep.nfa;
...
import top.zhanma.flink.dynamic.cep.nfa.aftermatch.AfterMatchSkipStrategy;
import top.zhanma.flink.dynamic.cep.nfa.compiler.NFACompiler;
import top.zhanma.flink.dynamic.cep.nfa.sharedbuffer.EventId;
import top.zhanma.flink.dynamic.cep.nfa.sharedbuffer.NodeId;
import top.zhanma.flink.dynamic.cep.nfa.sharedbuffer.SharedBuffer;
import top.zhanma.flink.dynamic.cep.nfa.sharedbuffer.SharedBufferAccessor;
import top.zhanma.flink.dynamic.cep.pattern.conditions.IterativeCondition;
import top.zhanma.flink.dynamic.cep.time.TimerService;
...
import top.zhanma.flink.dynamic.cep.operator.CepOperator;
...
import static top.zhanma.flink.dynamic.cep.nfa.MigrationUtils.deserializeComputationStates;
 ...
 * top.zhanma.flink.dynamic.cep.nfa.sharedbuffer.SharedBuffer buffer}, which is a memory-optimized data-structure exactly for this purpose. Events
...
public class NFA<T> {
     ...
     * remove "final" keyword of column states
     ...
     *       <ol>
     *         <li>IGNORE (links in {@link top.zhanma.flink.dynamic.cep.nfa.sharedbuffer.SharedBuffer} will still point to the previous event)
     *             <ul>
     ...
     *                   state)
     *               <li>lock the entry in {@link top.zhanma.flink.dynamic.cep.nfa.sharedbuffer.SharedBuffer} as it is needed in the created
     *                   branch
     *             </ul>
     *         <li>TAKE (links in {@link top.zhanma.flink.dynamic.cep.nfa.sharedbuffer.SharedBuffer} will point to the current event)
     *             <ul>
     ...
     *   <li>Release the corresponding entries in {@link top.zhanma.flink.dynamic.cep.nfa.sharedbuffer.SharedBuffer}.
     * </ol>
     *
     ...
     *
     * @param sharedBufferAccessor The accessor to {@link top.zhanma.flink.dynamic.cep.nfa.sharedbuffer.SharedBuffer} from which to extract the
     *     matches
    ...
    public static class MigratedNFA<T> {
        ...
        private final top.zhanma.flink.dynamic.cep.nfa.SharedBuffer<T> sharedBuffer;

        public top.zhanma.flink.dynamic.cep.nfa.SharedBuffer<T> getSharedBuffer() {
            return sharedBuffer;
        }
        ...
        MigratedNFA(
                ...
                final top.zhanma.flink.dynamic.cep.nfa.SharedBuffer<T> sharedBuffer) {
    ...
    public static final class NFASerializerConfigSnapshot<T>
        ...
        public NFASerializerConfigSnapshot(
                ...
                TypeSerializer<top.zhanma.flink.dynamic.cep.nfa.SharedBuffer<T>> sharedBufferSerializer) {
    ...
    public static final class MigratedNFASerializerSnapshot<T>
        ...
        protected NFASerializer<T> createOuterSerializerWithNestedSerializers(
            ...
            @SuppressWarnings("unchecked")
            TypeSerializer<top.zhanma.flink.dynamic.cep.nfa.SharedBuffer<T>> sharedBufferSerializer =
                    (TypeSerializer<top.zhanma.flink.dynamic.cep.nfa.SharedBuffer<T>>) nestedSerializers[1];
    ...
    public static class NFASerializer<T> extends TypeSerializer<MigratedNFA<T>> {
        ...
        private final TypeSerializer<top.zhanma.flink.dynamic.cep.nfa.SharedBuffer<T>>
        ...
        public NFASerializer(TypeSerializer<T> typeSerializer) {
            this(
                    typeSerializer,
                    new top.zhanma.flink.dynamic.cep.nfa.SharedBuffer.SharedBufferSerializer<>(
        ...
        public MigratedNFA<T> deserialize(DataInputView source) throws IOException {
            ...
            top.zhanma.flink.dynamic.cep.nfa.SharedBuffer<T> sharedBuffer =
