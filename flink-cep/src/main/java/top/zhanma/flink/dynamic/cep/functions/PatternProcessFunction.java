...
package top.zhanma.flink.dynamic.cep.functions;
...
import top.zhanma.flink.dynamic.cep.time.TimeContext;
...
public abstract class PatternProcessFunction<IN, OUT> extends AbstractRichFunction {
    ...
    public Pattern getPattern(IN flagElement){
        return listener.getPattern(flagElement);
    }

    public Boolean isPatternChanged(IN element){
        return listener.isPatternChanged(element);
    }
