...
//			更新逻辑
                .registerListener(new CEPListener<Tuple3<String, Long, String>>(){
                    @Override
                    public Boolean isPatternChanged(Tuple3<String, Long, String> element) {
                        return element.f0.equals("change");
                    }
                    @Override
                    public Pattern getPattern(Tuple3<String, Long, String> flagElement) {
